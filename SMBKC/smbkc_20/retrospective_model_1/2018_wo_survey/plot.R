...
# Model: model_1_18 / without terminal year of the survey
...
# Model 1 plots -------------------------
cur_yr <- 2018 # update annually 

mod_names <- c("retro_18_woTS")
...
rec %>% 
  ...
  write.csv(paste0(.FILES, paste0("recruitment_output_", cur_yr, "woTS.csv"))) 

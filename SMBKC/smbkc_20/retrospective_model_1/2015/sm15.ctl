## =============================================== updated for retro 2015 base model sept 2020     ##
...
# Gear-1
   ...
   1     1     1   0    0.4    0.001 1.0    0       0      1    3     2009   2014 # update end yr
   1     2     2   0    0.4    0.001 1.0    0       0      1    3     2009   2014 # update end yr
   1     3     3   0    1.0    0.001 2.0    0       0      1    -2    2009   2014 # update end yr
# Gear-2
   2     7     1   0    40      10.0  200    0      10    200   -3     1978   2014 # update end yr
   2     8     2   0    60      10.0  200    0      10    200   -3     1978   2014 # update end yr
# Gear-3
   3     9     1   0    40      10.0  200    0      10    200   -3     1978   2014 # update end yr
   3    10     2   0    60      10.0  200    0      10    200   -3     1978   2014 # update end yr
# Gear-4
   4     11    1   0    0.7     0.001 1.0    0       0      1   4     1978   2015 # update end yr
   4     12    2   0    0.8     0.001 1.0    0       0      1   4     1978   2015 # update end yr
   4     13    3   0    0.9     0.001 1.0    0       0      1   -5    1978   2015 # update end yr
# Gear-5
   5     14    1   0    0.4     0.001 1.0    0       0      1   4     1978   2015 # update end yr
   5     15    2   0    0.7     0.001 1.0    0       0      1   4     1978   2015 # update end yr
   5     16    3   0    1.0     0.001 2.0    0       0      1   -2    1978   2015 # update end yr
## Retained
# Gear-1
  -1     17    1   0    120        50 200    0      1    900    -7     1978   2014 # update end yr
  -1     18    2   0    123       110 200    0      1    900    -7     1978   2014 # update end yr
# Gear-2
  -2     19    1   0   595    1    999    0      1    999   -3     1978   2014 # update end yr
# Gear-3
  -3     20    1   0   595    1    999    0      1    999   -3     1978   2014 # update end yr
# Gear-4
  -4     21    1   0   595    1    999    0      1    999   -3     1978   2015 # update end yr
# Gear-5
  -5     22    1   0   595    1    999    0      1    999   -3     1978   2015 # update end yr
...
## ==================================================================================== ##
1978       # First rec_dev
2014       # last rec_dev (updated annually)

...
mod_names <- c("retro_18")
.MODELDIR = c("./SMBKC/smbkc_20/retrospective_model_1/2018/") # directory where the model results are
...
.SEAS     = c("Annual")
.FIGS     = c("./SMBKC/smbkc_20/retrospective_model_1/2018/output/")

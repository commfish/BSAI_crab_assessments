...
The parameter estimates in the "no pot" scenario differs greatly from the reference model, as expected, due to the removal of recent ADF&G pot survey data points that pulled the mmb trend downward (see Table \@ref(tab:est-pars-all)). 
...
Estimated recruitment is similar in both models until the mid-2000s when the **no pot** model has consistently higher recruitment, contributing to higher mmb for this model in recent years (Figure \@ref(fig:recruitment)). 
...
The **no pot** model (20.1) has a better fit to recent years of the NMFS trawl survey data, fitting most of the post-2010 data ranges (fit line encompasses the error bars), compared to the reference model that only fits three of the last 10 years. The improved fit of the trawl survey which corresponds to increased mmb estimates in the last 10 years. Not surprisingly this time frame also corresponds to sharp declines in the ADF&G pot survey abundance estimates that started in the post-2010 data. 
...
However, completion of a retrospective analysis, for the base model, was completed (\@ref(fig:retrospective)) and is presented in Appendix C.
...
The estimates of mature male biomass (Figure \@ref(fig:mmb)) for the **no pot** model differs from the reference models due to the removal of the pot survey abundance and size composition data. This abundance time series contrasts with the NMFS trawl survey and when present tends to lower the scale of the population estimate. 

...
```{r rec1, fig.cap = "Set up to show sensitivity of new data in 2020 on estimated recruitment ; 1978-2018, does not show recent recruitment, i.e. 2019."}
...
```{r recruitment, fig.cap = "Estimated recruitment 1979-2019 comparing model alternatives. The solid horizontal lines in the background represent the estimate of the average recruitment parameter ($\\bar{R}$) in each model scenario."}

...
The average percent difference between these quantities was approximately 1% overall and was the highest in OFL comparisons at an average difference of 4% (Table \@ref(tab:diff-compare)). Most differences were small and even unnoticable in years where the population trajectory was similar to the previous year. 
Based on this analyis the author does not recommend additional uncertainty in the ABC buffer for SMBKC for the 2020 base model. 

...
### Results {-}
Retrospective analysis of the base model show a retrospective pattern that tends to overestimate mmb in the terminal (Figure \@ref(fig:retrospective) and \@ref(fig:retrospective2)). Since 2018 the mmb estimates have been relatively stable, however, they are the lowest in the model history and reflect a time of overfished declaration for the stock. 

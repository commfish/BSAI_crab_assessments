...
1. **16.0 - 2020 Model**: 2020 accepted model

2. **16.0 - 2022 Base Model**: updated with 2020/21 groundfish bycatch & 2021 NMFS trawl data

3. **22.0a - 2022 Base Model with fixed M = 0.21**: natural mortality is increased to a base of 0.21 instead of 0.18

4. **22.0b - 2022 Base Model with fixed M = 0.26**: natural mortality is increased to a base of 0.26 instead of 0.18

5. **22.0c - 2022 Base Model, fixed M = 0.18 for all years**: natural mortality is fixed for all years at 0.18, no time blocks
...
Removing the period of higher natural mortality in 1998 forces the model to accommidate the large drop in survey biomass by increases in recruitment and overall changes in mature male biomass in the late 90s.   

Selectivity estimates for the directed fishery show some variability between the base models and model 22.0c, these differences accommodate the changes to the survey biomass estimates without increased natural mortality in 1998 (Figure \@ref(fig:selectivity)). 
...
Estimated mature male biomass on 15 February is similar among the models (Figure \@ref(fig:mmb)). Only model 22.0c (fixed M = 0.18 with no time blocks) as a different trajectory for mmb during the late 90s leading up to the large decline in 1998. 
Fits to the NMFS trawl survey data are similar among the model, once again with only model 22.0c having a lower trend in the 90s to fit the large drop in survey biomass from 1998 to 1999. 
...
The base model (model 16.0) fit to total male ($\ge$ 90 mm CL) trawl survey biomass tends to miss the recent peak around 2010 and fits recent survey data points on the lower end of their error bars (Figures \@ref(fig:trawl-survey-biomass)). 
...
However, completion of a retrospective analysis, for the base model, will be completed in Sept. (Figure \@ref(fig:retrospective)) and is presented in detail in an Appendix.

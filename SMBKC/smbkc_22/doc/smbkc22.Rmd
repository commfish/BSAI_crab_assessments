...
Estimated mature male biomass on 15 February is similar among the models (Figure \@ref(fig:mmb)). Only model 22.0c (fixed M = 0.18 with no time blocks) has a different trajectory for MMB during the late 90s leading up to the large decline in 1998. 
...
The model scenarios presented here explore the sensitivity of the base model to assumptions of level of natural mortality for this stock. With the exception of model 22.0c, the rest of the model suite produces a similar mature male biomass trajectory, with similar terminal year estimates of SSB (Figure \@ref(fig:mmb)). 
...
knitr::include_graphics("safe_figure/data_extent_manual.png", dpi = 250)
```

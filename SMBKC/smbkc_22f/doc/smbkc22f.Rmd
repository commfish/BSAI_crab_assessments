...
Model parameter estimates for the GMACS reference model are summarized in Tables \@ref(tab:est-pars-ref). Negative log-likelihood values and management measures for the reference model are provided in Tables \@ref(tab:management-quants) and \@ref(tab:likelihood-components).

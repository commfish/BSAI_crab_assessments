...
# Summary {-}
The Saint Matthew Island blue king crab (SMBKC) assessment is now on a biennial cycle (approved by the CPT in Jan 2021, SSC in Feb 2021). 2021 if the "off" year in the cycle, so only an update to determine overfishing status in the 2020/21 season is presented here. However, multi-year OFLs and ABCs were NOT set in the September 2020 SAFE therefore those need to be set for the 2021/22 season.
...
Based on the 2020 accepted model for SMBKC, the estimate for mature male biomass was below the minimum stock-size threshold (MSST) in 2020/21 and continues to be in an "overfished" condition, despite a directed fishery closure since the 2016/17 season. Total catch for 2020/21 is below the OFL, overfishing did not occur on this stock in 2020/21 (Tables \@ref(tab:status) and  \@ref(tab:ofl-basis)). 

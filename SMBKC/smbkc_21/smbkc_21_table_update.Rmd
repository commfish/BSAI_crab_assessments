...
# Summary {-}
The Saint Matthew Island blue king crab (SMBKC) assessment is now on a biennial cycle. 2021 if the "off" year in the cycle, so only an update to determine overfishing status in the 2020/21 season is presented here. However, multi-year OFLs and ABCs were NOT set in the September 2020 SAFE therefore those need to be set for the 2021/22 season.

The most recent assessment was conducted in September 2020. In that assessment and this update, estimated total male catch is the sum of fishery-reported retained catch, estimated male discard mortality in the directed fishery, and estimated male bycatch mortality in the groundfish fisheries. Since the directed fishery is closed the total catch is the sum of the bycatch mortality in the groundfish fisheries and other crab fisheries. 

Based on the 2020 accepted model for SMBKC, the estimate for mature male biomass was below the minimum stock-size threshold (MSST) in 2020/21 and continutes to be in an "overfished" condition, despite a directed fishery closure since the 2016/17 season. Total catch for 2020/21 is below the OFL, overfishin did not occur on this stock in 2020/21 (Tables \@ref(tab:status) and  \@ref(tab:ofl-basis)). 

# katie.palof@alaska.gov    8-21-19/ 4-9-2020/ 5-5-2020 

# exercise without q block just to see some things.
# DO NOT USE for document !!!!!!!!!
...
.SEAS     = c("1","2","3","4","5")
.FIGS     = c("./SMBKC/smbkc_19a/doc/exploration/")

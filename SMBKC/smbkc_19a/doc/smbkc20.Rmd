...
to the reference model. In summary, the following lists the models presented and the naming convention used: **update**

1. **16.0 - 2019 Model**: the 2019 recommended model without any new data

2. **16.0 - 2019 Reference Model**: updated with Jan 2020 updates to GMACS

3. **19.1 - VAST NMFS trawl data**: model 19.0 with VAST data output for the NMFS trawl survey time series 

4. **19.2 - add CV pot**: includes an estimated additional CV on the ADF&G pot survey

5. **19.3 - add CV both**: includes an estimated additional CV on the ADF&G pot survey and the NOAA trawl survey 

6. **19.4 - q time block pot**: time block estimated q's for ADF&G pot survey. 2 time blocks: 1995 to 2013 and 2015 to 2018. 

Note the naming convention. The base model is model 16.0 since that was the year of model development. 

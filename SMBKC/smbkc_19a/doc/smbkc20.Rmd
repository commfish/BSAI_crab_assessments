...
knitr::include_graphics("safe_figure/trawl_cpue_ref.png", dpi = 125)
```
...
knitr::include_graphics("safe_figure/pot_cpue_ref.png", dpi = 125)
```

```{r rec1, fig.cap = "Set up to show sensitivity of new data in 2020 on estimated recruitment ; 1978-2018."}
knitr::include_graphics("safe_figure/recruit_ref.png", dpi = 125)
```

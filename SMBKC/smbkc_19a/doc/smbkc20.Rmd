...
```{r surv1, fig.cap = "Fits to NMFS area-swept trawl estimates of total ($/ge$ 90mm) male survey biomass for the reference model only (will show 16.0 ref with new data and 16.0 as last year's accepted model). Error bars are plus and minus 2 standard deviations."} 
knitr::include_graphics("safe_figure/trawl_cpue_ref.png", dpi = 200)
```

```{r surv1-vast, fig.cap = "Fits to NMFS area-swept trawl estimates of total ($/ge$ 90mm) male survey biomass for the VAST model only, data plotted here are VAST trawl survey estimates. Error bars are plus and minus 2 standard deviations."} 

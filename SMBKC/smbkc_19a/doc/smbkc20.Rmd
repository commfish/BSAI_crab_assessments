...
In summary, these model scenarios were provided to explore the sensitivity of this model. Currently, the reference model is still the most appropriate model for settting reference points and model specifications. 
...
```{r trawl-survey-biomass-base-vast, fig.cap = "Comparisons of area-swept estimates of total (90+ mm CL) male survey biomass (tons) and model predictions for the reference model and the VAST model. The error bars are plus and minus 2 standard deviations. Triangles represent VAST survey estimtaes."} 

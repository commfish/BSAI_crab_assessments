...
# the model specs
mod_names <- c("model 16.0", "model 16.0 (ref)", "model 19.1 (fit survey)", "model 19.2 (add CV pot)", "model 19.0a (alt regime)") 
.MODELDIR = c(paste0(here::here(), "/SMBKC/smbkc_19/model_1/"), 
              paste0(here::here(), "/SMBKC/smbkc_19a/model_1/"),
              paste0(here::here(), "/SMBKC/smbkc_19a/model_5/"), 
              paste0(here::here(), "/SMBKC/smbkc_19a/model_1b/"), 
              paste0(here::here(), "/SMBKC/smbkc_19a/model_1a/")) #need to update these model options

...
# Model: model_1a : additional CV on ADFG pot survey
...
mod_names <- c("add CV pot")
.MODELDIR = c("./SMBKC/smbkc_19a/model_1a/") # directory where the model results are
...
.SEAS     = c("Annual")
.FIGS     = c("./SMBKC/smbkc_19a/model_1a/figure/")

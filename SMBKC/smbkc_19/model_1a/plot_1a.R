...
mod_names <- c("model_1a")
.MODELDIR = c("./SMBKC/smbkc_19/model_1a/") # add /initial_run/ to get the initial run results
...
.SEAS     = c("Annual")
.FIGS     = c("./SMBKC/smbkc_19/model_1a/figure/")
...
write_csv(ofl_df, paste0('./SMBKC/smbkc_19/model_1a/ofl_table_', mod_names, '.csv'))

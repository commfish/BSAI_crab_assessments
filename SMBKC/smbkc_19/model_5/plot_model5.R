...
require(gmr)
#setwd("./smbkc_19/model_5")

# Model 5 plots -------------------------
# ploting for model 5 under smbkc19 folder - using gmr and Jim's code 

mod_names <- c("model_5")
.MODELDIR = c("./SMBKC/smbkc_19/model_5/")
...
.SEAS     = c("Annual")
.FIGS     = c("./SMBKC/smbkc_19/model_5/figure/")
...
write_csv(ofl_df, paste0('./SMBKC/smbkc_19/model_5/ofl_table_', mod_names, '.csv'))

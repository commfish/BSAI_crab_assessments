...
require(gmr)
#setwd("./smbkc_19/model_1b")

# Model 1b plots -------------------------
# ploting for model 1b under smbkc19 folder - using gmr and Jim's code 
cur_yr <- 2019 # update annually 

mod_names <- c("model_1b")
.MODELDIR = c("./SMBKC/smbkc_19/model_1b/") # add /initial_run/ to get the initial run results
...
.SEAS     = c("Annual")
.FIGS     = c("./SMBKC/smbkc_19/model_1b/figure/")
...
write_csv(ofl_df, paste0('./SMBKC/smbkc_19/model_1b/ofl_table_', mod_names, '.csv'))

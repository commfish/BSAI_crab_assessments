...
# Regime shifts{-}
Current model output (using the reference model) of both biomass and recruitment suggest a shift from higher levels in the first have of the time series to lower levels in the recent regime. These trends warrented an examination of the modeled data to determine if a regime shift has occured. 
...
Rebuilding time under any of the projection combinations is insensitive to the average values for recent (2013 - 2017 or 2014 - 2018) bycatch. As a sensitivity analysis the projections presented here were also performed using the maximum observed bycatch value, corresponding to year 2007, and are presented in this document.
...
These projections use the state harvest policy as the upper fishing mortality and included average recent bycatch mortality (2014 - 2018). Additionally, sensitivity on $T_{min}$ values to higher bycatch mortality are included to help inform the rebuilding time frame. 
...
\begin{tabular}{lcccccccc}
  ...
  \hline
  2018/19 & 1978-2018 & 3.48 & 1.74 & 1.09 & 0.31 & 0.041 & 0.18 \\ 
  2018/19 & 1996-2018 & 2.03 & 1.015 & 1.08 & 0.53 & 0.087 & 0.18 \\ 
  \hline
\end{tabular}
\end{table}

...
.MODELDIR = c(paste0(here::here(), "/SMBKC/smbkc_18a/model_1/"), paste0(here::here(), "/SMBKC/smbkc_18a/model_4/"), paste0(here::here(), "/SMBKC/smbkc_18a/model_5/")) #need to update these model options
...
ref_mod <- 1 # base
rec_mod <- 1 # base
mod_scen<- 1:3 #scenarios you want graphed together
```

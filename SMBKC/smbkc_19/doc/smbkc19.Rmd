...
#plot_ssb(M[1:2], ylab = "Mature male biomass (tons) on 15 February")# needs to be fixed **FIX**  to refect curernt year projection and error associated.
...
knitr::include_graphics("safe_figure/lf_1.png")
```
...
```{r sc-trawl-discarded, fig.cap = "Observed and model estimated size-frequencies of discarded SMBKC by year in the ADF&G pot survey for the model scenarios."}

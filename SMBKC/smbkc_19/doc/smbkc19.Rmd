...
```{r sc-pot-res-selex, fig.cap = "Bubble plots of residuals by stage and year for the all the size composition data sets (ADF&G pot survey, NMFS trawl survey, and the directed pot fishery) for SMBKC in the **reference** model (19.0)."}
plot_size_comps_res(M[ref_mod])
```

```{r sc-trawl-discarded-res, fig.cap = "Bubble plots of residuals by stage and year for the all the size composition data sets (ADF&G pot survey, NMFS trawl survey, and the directed pot fishery) for SMBKC in the **fit surveys** model (19.1)."}
plot_size_comps_res(M[3])
```

```{r sc-trawl-discarded-cv, fig.cap = "Bubble plots of residuals by stage and year for the all the size composition data sets (ADF&G pot survey, NMFS trawl survey, and the directed pot fishery) for SMBKC in the **add CV pot** model (19.2)."}

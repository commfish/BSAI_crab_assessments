...
\begin{tabular}{lccccccc}
  ...
  2018/19 & `r round(M[[rec_mod]]$spr_bmsy/1000 * 0.5, 2)`$^E$ & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)-1]/1000, 2)`$^E$ & 0.00 & 0.00 & 0.001 & 0.04 & 0.03 \\
  2019/20 & & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)]/1000, 2)`$^E$ & & & & `r round(M[[rec_mod]]$spr_cofl/1000, 2)` & `r round(M[[rec_mod]]$spr_cofl/1000*0.8, 2)` \\
 \\
  \hline
\end{tabular}
\end{table}

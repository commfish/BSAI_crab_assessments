...
3
# Male weight-at-length - need a row for each year
...
##      4 = Time blocks
##      5 = option 3 but back to base instead of newly estimated M
##      6 = option 4 but back to base instead of new estimated M
## ==================================================================================== ##
## Type
6

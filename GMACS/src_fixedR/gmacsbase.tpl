...
FUNCTION initialize_model_parameters
  ...
  //Fix recruitment deviation in the terminal year to the previous seven years of average 
  for ( int i = nyr-7; i <= nyr-1; i++)
   {
    rec_dev(nyr) += rec_dev_est(i);
    logit_rec_prop(nyr) += logit_rec_prop_est(i);
   }
  rec_dev(nyr) = rec_dev(nyr)/7.0;
  logit_rec_prop(nyr) = logit_rec_prop(nyr)/7.0;

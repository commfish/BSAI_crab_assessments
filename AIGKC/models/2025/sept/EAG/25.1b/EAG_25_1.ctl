...
1.00 # Initial value for recruitment sex-ratio
...
# #  Directed_Fishery GF_Bycatch Coop_Survey
 0 0 0 # is selectivity sex=specific? (1=Yes; 0=No)
 2 5 2 # male selectivity type
 0 0 0 # selectivity within another gear
 0 0 0 # male extra parameters for each pattern
 1 1 1 # male: is maximum selectivity at size forced to equal 1 (1) or not (0)
 0 0 0 # size-class at which selectivity is forced to equal 1 (ignored if the previous input is 1)
## Retention specifications --
 0 0 0 # is retention sex=specific? (1=Yes; 0=No)
 2 6 6 # male retention type
 1 0 0 # male retention flag (0 = no, 1 = yes)
 0 0 0 # male extra parameters for each pattern
 0 0 0 # male - should maximum retention be estimated for males (1=Yes; 0=No)
...
# Inputs for type*sex*fleet: selectivity male Coop_Survey
# MAIN PARS:  Initial  Lower_bound  Upper_bound Prior_type     Prior_1      Prior_2  Phase  Block Blk_fn  Env_L Env_vr     RW RW_Blk RW_Sigma
           121.266444   105.000000   180.000000          0   100.000000   190.000000      3      0      0      0      0      0      0   0.3000 # Sel_Coop_Survey_male_base_Logistic_mean
            23.514311     0.010000    40.000000          0     0.100000    50.000000      3      0      0      0      0      0      0   0.3000 # Sel_Coop_Survey_male_base_Logistic_cv
...
#      Initial    Lower_bound    Upper_bound  Prior_type        Prior_1        Prior_2  Phase 
    ...
    0.00053595     0.00000010     0.01000000           0     0.00000000     1.00000000      1 # Survey_q_parameter_4
...
#      Initial    Lower_bound    Upper_bound  Prior_type        Prior_1        Prior_2  Phase 
    ...
    0.00000010     0.00000010     0.50000000           0     0.50000000   100.00000000     -6 # Add_cv_parameter_4
...
#   Initial_male_F  Initial_fem_F   Pen_SD (mal)   Pen_SD (fem) Phz_mean_F_mal Phz_mean_F_fem   Lower_mean_F   Upper_mean_F Low_ann_male_F  Up_ann_male_F    Low_ann_f_F     Up_ann_f_F
          ...
          0.000000       0.000000       3.000000      15.000000      -2.000000      -1.000000     -12.000000       4.000000     -10.000000      10.000000     -10.000000      10.000000  # Coop_Survey
...
#  Directed_Fishery Directed_Fishery Coop_Survey
#   M    M    M  
#  ret  tot  tot 
#  N+S  N+S  N+S 
#  I+M  I+M  I+M 
      6      6      6 # Type of likelihood
...
#   Mean_M_fdevs | Mean_F_fdevs |  Ann_M_fdevs |  Ann_F_fdevs
          ...
          0.0000         0.0000         0.0010         0.0000 # Coop_Survey

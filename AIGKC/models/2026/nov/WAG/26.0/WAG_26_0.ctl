...
0.50 # Initial value for recruitment sex-ratio
   0 # Initial conditions (0 = Unfished, 1 = Steady-state fished, 2 = Free parameters, 3 = Free parameters (revised)), 5 = zero population
...
0.1063 0.4244 # Lambda for effective sample size

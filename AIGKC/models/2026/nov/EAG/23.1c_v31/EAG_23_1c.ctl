## GMACS Version 2.20.31; ** WTS **; Compiled 2025-07-17
...
## ==================================================================================== ##
## 
5   # Maximum number of size-classes to which recruitment must occur
...
1      2 # Composition Splicer codes
1      1 # Set to 1 for catch-based predictions; 2 for survey or total catch predictions
0.1993 0.5493 # Lambda for effective sample size
1      1 # emphasis for overall likelihood
0      0 # Survey to set Q for this comp


      

# Effective sample size parameters (number matches max(Composition Splicer code)) 
#      Initial    Lower_bound    Upper_bound  Prior_type        Prior_1        Prior_2  Phase 

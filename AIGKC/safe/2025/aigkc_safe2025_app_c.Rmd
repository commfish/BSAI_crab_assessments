...
The ABC buffer for AIGKC is determine qualitatively after assessing model performance and associated uncertainty in management quantities, ecosystem status, and stock trajectory. The below risk table details information considered in that determination.
...
The the WAG has been below B$_{\text{MSY}}$ since the 2022/23, while the EAG has remained above B$_{\text{MSY}}$ since the stock has been managed using Tier 3 harvest control rules.
...
\item{The western and central Aleutians experienced a marine heat wave at the beginning of the 2024 crab year, though bottom temperatures remained cooler near the 1991 - 2012 average. The eastern Aleutians were less afected.}

...
# updated for May 2023 models - figure out how to graph these elsewhere 
source("./BBRKC/code/bbrkc_functions.R")

A <- read_rep("./BBRKC/bbrkc_22f/model_211b/gmacs.rep")
B <- read_rep("./BBRKC/bbrkc_23s/model_211b/gmacs.rep")
C <- read_rep("./BBRKC/bbrkc_23s/model_23_0/gmacs.rep") #base M for males =0.257
D <- read_rep("./BBRKC/bbrkc_23s/model_23_0a/gmacs.rep")# base M for males estimated
E <- read_rep("./BBRKC/bbrkc_23s/model_23_0b/gmacs.rep")# base M for males =0.31 (likelihood profile)
F <- read_rep("./BBRKC/bbrkc_23s/model_231a/gmacs.rep")# increase CV on q for NMFS trawl survey
G <- read_rep("./BBRKC/bbrkc_23s/model_22/gmacs.rep") # starts in 1985
H <- read_rep("./BBRKC/bbrkc_23s/model_23_3/gmacs.rep") # combo of 23.0a and 23.1a
I <- read_rep("./BBRKC/bbrkc_23s/model_23_2_noretow/gmacs.rep") # combo of 23.0a and 23.1a
...
# function moved to 'bbrkc_functions.R' file
...
## rec 3 ----------------
# Figure 12a 22f, 'recruitment_mod_scen.png'
n1<-3
n2<-1
n3<-B$nyr-B$syr+1
n4<-C$nyr-C$syr+1
...
mtext('Length (mm)',1,2.10,outer=T,cex=1.0)
par(mfrow=c(1,1))
# saved as "recruitment_length_dist_mod_scen.png'
...
# functions moved to 'bbrkc_functions.R'


### TABLES ------------ updated 4-30-23
# table 4, im-ess ---------------
...
# table 5a ------
# likilihoods updated 5-2-23
d1f<-c(361,359,359,360,354,354,355,355)
d2f<-c(0.930,0.972,0.915,0.950,0.951,0.936,0.920,0.917)
...
#d1m<-c(A$Catches,A$Index,A$Size_compositions,A$Recruitment_penalities,A$Other_penalties,A$Initial_size_structure,sum(A$priorDensity),A$Total,d1f[1],A$spr_bmsy,A$spr_bmsy*A$spr_depl,A$sd_fmsy[1],A$sd_fofl[1],A$spr_cofl,A$spr_cofl*0.8,d2f[1])
#d2m<-c(B$Catches,B$Index,B$Size_comp_like,B$Recruit_pen,B$Other_penalties,B$Initial_size_structure,sum(B$priorDensity),B$Total,d1f[2],B$spr_bmsy,B$spr_bmsy*B$spr_depl,B$sd_fmsy[1],B$sd_fofl[1],B$spr_cofl,B$spr_cofl*0.8,d2f[2])
base22f<-c(A$Catches,A$Index,A$`Size-compositions`,A$Recruitment_penalities,A$Other_penalties[c(1,3,7)], sum(A$priorDensity),A$spr_bmsy,A$spr_bmsy*A$spr_depl,A$sd_fmsy[1],A$sd_fofl[1],A$spr_cofl,A$spr_cofl*0.8,A$survey_q[1])
base23s<-c(B$Catches,B$Index,B$Size_comp_like,B$Recruit_pen,B$MeanF_pen, B$M_devs, B$Sex_ratio,sum(B$priorDensity),B$spr_bmsy,B$spr_bmsy*B$spr_depl,B$sd_fmsy[1],B$sd_fofl[1],B$spr_cofl,B$spr_cofl*0.8,B$survey_q[1])
m230<-c(C$Catches,C$Index,C$Size_comp_like,C$Recruit_pen,C$MeanF_pen, C$M_devs, C$Sex_ratio,sum(C$priorDensity),C$spr_bmsy,C$spr_bmsy*C$spr_depl,C$sd_fmsy[1],C$sd_fofl[1],C$spr_cofl,C$spr_cofl*0.8,C$survey_q[1])
m230a<-c(D$Catches,D$Index,D$Size_comp_like,D$Recruit_pen,D$MeanF_pen, D$M_devs, D$Sex_ratio,sum(D$priorDensity),D$spr_bmsy,D$spr_bmsy*D$spr_depl,D$sd_fmsy[1],D$sd_fofl[1],D$spr_cofl,D$spr_cofl*0.8,D$survey_q[1])
m230b<-c(E$Catches,E$Index,E$Size_comp_like,E$Recruit_pen,E$MeanF_pen, E$M_devs, E$Sex_ratio,sum(E$priorDensity),E$spr_bmsy,E$spr_bmsy*E$spr_depl,E$sd_fmsy[1],E$sd_fofl[1],E$spr_cofl,E$spr_cofl*0.8,E$survey_q[1])
m231a<-c(F$Catches,F$Index,F$Size_comp_like,F$Recruit_pen,F$MeanF_pen, F$M_devs, F$Sex_ratio,sum(F$priorDensity),F$spr_bmsy,F$spr_bmsy*F$spr_depl,F$sd_fmsy[1],F$sd_fofl[1],F$spr_cofl,F$spr_cofl*0.8,F$survey_q[1])
m22<-c(G$Catches,G$Index,G$Size_comp_like,G$Recruit_pen,G$MeanF_pen, G$M_devs, G$Sex_ratio,sum(G$priorDensity),G$spr_bmsy,G$spr_bmsy*G$spr_depl,G$sd_fmsy[1],G$sd_fofl[1],G$spr_cofl,G$spr_cofl*0.8,G$survey_q[1])
m233<-c(H$Catches,H$Index,H$Size_comp_like,H$Recruit_pen,H$MeanF_pen, H$M_devs, H$Sex_ratio,sum(H$priorDensity),H$spr_bmsy,H$spr_bmsy*H$spr_depl,H$sd_fmsy[1],H$sd_fofl[1],H$spr_cofl,H$spr_cofl*0.8,H$survey_q[1])
m232 <-c(I$Catches,I$Index,I$Size_comp_like,I$Recruit_pen,I$MeanF_pen, I$M_devs, I$Sex_ratio,sum(I$priorDensity),I$spr_bmsy,I$spr_bmsy*I$spr_depl,I$sd_fmsy[1],I$sd_fofl[1],I$spr_cofl,I$spr_cofl*0.8,I$survey_q[1]) 

#d8m<-c(H$Catches,(H$Index[1]+H$Index[2]),H$Index[3],H$Size_comp_like,H$Recruit_pen,H$Other_penalties,H$Initial_size_structure,sum(H$priorDensity),H$Total,d1f[8],H$spr_bmsy,H$spr_bmsy*H$spr_depl,H$sd_fmsy[1],H$sd_fofl[1],H$spr_cofl,H$spr_cofl*0.8,d2f[8])
d9m<-cbind(d3f_names,base22f, base23s, m230, m230a, m230b, m231a, m22, m233)
#d1m<-d5m-d1m
#d2m<-d5m-d2m
#d3m<-d5m-d3m
#d4m<-d5m-d4m
#d6m<-cbind(d6m,d1m,d2m,d3m,d4m)
#d10m<-d9m[c(1:18,20:21,23,27:38),]
write.csv(d9m,"./BBRKC/bbrkc_23s/doc/tables/likelihood.csv", row.names = FALSE)

# no retow ----
d10m <-cbind(d3f_names, base23s, m232)
write.csv(d10m,"./BBRKC/bbrkc_23s/doc/tables/likelihood_noretow.csv", row.names = FALSE)

### Table 6 --------
## Table 9, model 21.1b --------
n4<-192 # what is this value?
Z<-read.table("./BBRKC/bbrkc_23s/model_211b/gmacs.std", header = TRUE, sep = "", quote = "", colClasses = c("numeric","character","numeric","numeric"), nrows = -1, skip = 0, check.names = TRUE)
#library(xlsx)
...
write.csv(d4m,"./BBRKC/bbrkc_23s/doc/gmacs-sum_model211b.csv", row.names = FALSE) # results go in Table 9
...
d7<-cbind(d5,d6)
write.csv(d7,"./BBRKC/bbrkc_23s/doc/gmacs-para_model211b.csv", row.names = FALSE)

# table 6&9, model 22 ----------
n4<-192 # what is this value?
Z<-read.table("./BBRKC/bbrkc_23s/model_22/gmacs.std", header = TRUE, sep = "", quote = "", colClasses = c("numeric","character","numeric","numeric"), nrows = -1, skip = 0, check.names = TRUE)
#library(xlsx)
W<-G # output for this model as letter
n10<-2000 # same here?
#n10<-796
n1<-12
n2<-6
...
d3b<-c(d3b0,n6)
d4m<-cbind(year,d1m,d1l,d3m,d3b,d1f,d2r,d2m,d2b)
write.csv(d4m,"./BBRKC/bbrkc_23s/doc/gmacs-sum_model22.csv", row.names = FALSE) # results go in Table 9
# column names: Mature males, Legal males, MMB, sd MMB, Mature Females, Total Recruits, Survey biomass model est.(>64), area-swept(>64)
# these results are in order but last two columns skip 2020 so you need to accomidate that in table - basically insert 0, 0 for 2020 and move
#     observations down
d5<-Z[1:n4,1:4]
...
d5[97:146,]<-Z[193:242,]
d6[97:146,]<-Z[243:292,]
d5[147:n4,]<-Z[293:(293+n4-147),] # don't know what these numbers mean but know I need to go until
#d6[147:n4,]<-Z[(293+n4-146):(n4+n4),]
d7<-cbind(d5,d6)
write.csv(d7,"./BBRKC/bbrkc_23s/doc/gmacs-para_model22.csv", row.names = FALSE)

## Table 6&9, model 23.0a --------
n4<-192 # what is this value?
Z<-read.table("./BBRKC/bbrkc_23s/model_23_0a/gmacs.std", header = TRUE, sep = "", quote = "", colClasses = c("numeric","character","numeric","numeric"), nrows = -1, skip = 0, check.names = TRUE)
#library(xlsx)
W<-D # CHANGE THIS !!!output for this model as letter
n10<-2000 # same here?
#n10<-796
n1<-12
n2<-6
...
d3b<-c(d3b0,n6)
d4m<-cbind(year,d1m,d1l,d3m,d3b,d1f,d2r,d2m,d2b)
write.csv(d4m,"./BBRKC/bbrkc_23s/doc/gmacs-sum_model230a.csv", row.names = FALSE) # results go in Table 9
# column names: Mature males, Legal males, MMB, sd MMB, Mature Females, Total Recruits, Survey biomass model est.(>64), area-swept(>64)
# these results are in order but last two columns skip 2020 so you need to accomidate that in table - basically insert 0, 0 for 2020 and move
#     observations down
d5<-Z[1:n4,1:4]
...
d6[147:n4,]<-Z[(293+n4-146):(n4+n4),]
d7<-cbind(d5,d6)
write.csv(d7,"./BBRKC/bbrkc_23s/doc/gmacs-para_model230a.csv", row.names = FALSE)

## Table 6&9, model 23.3 --------
n4<-192 # what is this value?
Z<-read.table("./BBRKC/bbrkc_23s/model_23_3/gmacs.std", header = TRUE, sep = "", quote = "", colClasses = c("numeric","character","numeric","numeric"), nrows = -1, skip = 0, check.names = TRUE)
#library(xlsx)
W<-H # CHANGE THIS !!output for this model as letter
n10<-2000 # same here?
#n10<-796
n1<-12
n2<-6
...
d3b<-c(d3b0,n6)
d4m<-cbind(year,d1m,d1l,d3m,d3b,d1f,d2r,d2m,d2b)
write.csv(d4m,"./BBRKC/bbrkc_23s/doc/gmacs-sum_model233.csv", row.names = FALSE) # results go in Table 9
# column names: Mature males, Legal males, MMB, sd MMB, Mature Females, Total Recruits, Survey biomass model est.(>64), area-swept(>64)
# these results are in order but last two columns skip 2020 so you need to accomidate that in table - basically insert 0, 0 for 2020 and move
#     observations down
d5<-Z[1:n4,1:4]
...
d6[147:n4,]<-Z[(293+n4-146):(n4+n4),]
d7<-cbind(d5,d6)
write.csv(d7,"./BBRKC/bbrkc_23s/doc/gmacs-para_model233.csv", row.names = FALSE)


## Table 6&9, model 23.2 --------
n4<-192 # what is this value?
Z<-read.table("./BBRKC/bbrkc_23s/model_23_2_noretow/gmacs.std", header = TRUE, sep = "", quote = "", colClasses = c("numeric","character","numeric","numeric"), nrows = -1, skip = 0, check.names = TRUE)
#library(xlsx)
W<-I # CHANGE THIS !!!!!!!!!output for this model as letter
n10<-2000 # same here?
#n10<-796
n1<-12
n2<-6
...
d3b<-c(d3b0,n6)
d4m<-cbind(year,d1m,d1l,d3m,d3b,d1f,d2r,d2m,d2b)
write.csv(d4m,"./BBRKC/bbrkc_23s/doc/gmacs-sum_model232.csv", row.names = FALSE) # results go in Table 9
# column names: Mature males, Legal males, MMB, sd MMB, Mature Females, Total Recruits, Survey biomass model est.(>64), area-swept(>64)
# these results are in order but last two columns skip 2020 so you need to accomidate that in table - basically insert 0, 0 for 2020 and move
#     observations down
d5<-Z[1:n4,1:4]
...
d6[147:n4,]<-Z[(293+n4-146):(n4+n4),]
d7<-cbind(d5,d6)
write.csv(d7,"./BBRKC/bbrkc_23s/doc/gmacs-para_model232.csv", row.names = FALSE)
### surveybio ---------

# k.palof
# 8-16-22  / 4-21-23
# Figures and Tables - May 2023 base model vs model without RETOW data for females
...
.SEAS     = c("1","2","3","4","5")
.FIGS     = c("./BBRKC/bbrkc_23s/doc/figures/retow/")
.TABS     = c("./BBRKC/bbrkc_23s/doc/tables/retow/")
...
ggsave(paste0(.FIGS, "selectivity_23s_retow.png"), width = ww*1.20, height = 1.1*hh)
#?? may need to use Jie's code here to get just the trawl survey
plot_selectivity_kjp(M[1:2], "NMFS Trawl")
ggsave(paste0(.FIGS, "selectivity_23s_trawl_retow.png"), width = ww*1.50, height = 0.85*hh)

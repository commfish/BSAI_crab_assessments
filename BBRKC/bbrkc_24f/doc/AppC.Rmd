...
As defined by the Crab FMP stock status is determined by the current years biomass (B) compared to the average biomass over a period of time. For consistencies with the current modeling approaches for BBRKC the time period used is 1984 to 2023, this is the same time period that is used in the Tier 3 model for calculation status determination.

...
This modeling exercise applies a an ABC buffer similar to the 2023 Tanner crab REMA model, where the ABC buffer is estimated to be the CV of the final year of the REMA output rounded to the nearest 5%.

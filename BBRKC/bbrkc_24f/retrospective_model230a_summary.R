...
#folder <- "bbrkc_24f/model_23_0a_ph7_24/retrospective" # update annually 
...
plot_save <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures/retro230a")

m230a_24 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/Gmacsall.out", model_name = "m23.0a (2024)", version = "2.20.14")

m2023 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro1/Gmacsall.out", model_name = "2023", version = "2.20.14")
m2022 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro2/Gmacsall.out", model_name = "2022", version = "2.20.14")

m2021 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro3/Gmacsall.out", model_name = "2021", version = "2.20.14")
m2020 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro4/Gmacsall.out", model_name = "2020", version = "2.20.14")
m2019 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro5/Gmacsall.out", model_name = "2019", version = "2.20.14")
m2018 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro6/Gmacsall.out", model_name = "2018", version = "2.20.14")
m2017 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro7/Gmacsall.out", model_name = "2017", version = "2.20.14")
m2016 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro8/Gmacsall.out", model_name = "2016", version = "2.20.14")
m2015 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro9/Gmacsall.out", model_name = "2015", version = "2.20.14")
m2014 <- gmacs_read_allout(file = "./BBRKC/bbrkc_24f/model_23_0a_ph7_24/retrospective/retro10/Gmacsall.out", model_name = "2014", version = "2.20.14")

retro_models <- list(m230a_24, m2023, m2022, m2021, m2020, m2019, m2018, m2017, m2016, m2015, m2014)
...
temp1 %>% 
  ...
  mutate(ssb = ssb/1000) %>% 
  mutate(model.end.yr = ifelse(model == 'm23.0a (2024)', 2023, as.integer(model)-1)) %>% 
...
mohn(out4, peels = 10, details = TRUE, plot = TRUE) # 0.2289245
...
ggsave(paste0(plot_save, "/recruitment_retrospective_model_230a.png"), width = 1.35*6, height = 9)

#ggsave(paste0("./BBRKC/", folder,"/recruitment_retrospective_model_230a.png"), width = 1.35*6, height = 9)
...
ratioR %>% 
  ...
  theme(legend.position = c(0.8, 0.59), 
        ...
        axis.text = element_text(size = 13), 
        axis.title = element_text(size = 13))
ggsave(paste0(plot_save, "/ratio_to_terminal_yr_model230a.png"), width = 1.1*6, height = 4.2)
...
ggsave(paste0(plot_save, "/Recruitment_Mean_sd_ratio_model230a.png"), width = 1.1*6, height = 4.0)
#### ------------------

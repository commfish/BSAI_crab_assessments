...
df <- read.csv(paste0(here::here(), '/BBRKC/bbrkc_25f/doc/figures/REMA/specs_REMA.csv'))
df %>% 
...
tab       <- xtable(df, caption = "Specificatoins using the REMA output on mature male NFMS trawl survey area-swept biomass (mt).", label = "tab:specs-rema")

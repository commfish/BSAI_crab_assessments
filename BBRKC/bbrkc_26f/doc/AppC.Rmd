...
As defined by the Crab FMP, stock status is determined by the current years biomass (B) compared to the average biomass over a period of time. For consistencies with the current modeling approaches for BBRKC the time period used is 1984 to 2025, as this is the same time period that is used in the Tier 3 model for status determination.
...
df <- read.csv(paste0(here::here(), '/BBRKC/', folder, '/doc/figures/REMA/specs_REMA.csv'))
df %>% 

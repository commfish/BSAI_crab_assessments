...
# 4-12-24 / 6-13-24 / 7-10-24 / 4-22-25 / 8-1-25 / 1-27-26 / 4-17-26 /7-28-26
# load ----------
...
# **************************************************************************************************
cur_yr <- 2026 # update annually when new data added
...
plot_save_base <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures")
plot_save_bridge <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures/v39")
plot_save_bridge <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures/v44")
...
#plot_save_compare <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures/m26.0a compare")
#plot_save_extend <- paste0(here::here(), "/BBRKC/", folder, "/doc/figures/extended_size_illustrate/")
...
#table directory 
.TABS     = c("./BBRKC/bbrkc_26f/doc/tables/")
.FIGS     = c("./BBRKC/bbrkc_26f/doc/figures/")
...
##      - 24.0c.2 - accepted model in fall 2025 # eventually list other models here 
...
m24c.2_v34a <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26s/v34a/Gmacsall.out"), model_name = "m24.0c.2_v34a", version = "2.20.34a")
#m24c.2_v34a <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26s/24.0c.2_tanner/Gmacsall.out"), model_name = "m24.0c.2_v34a", version = "2.20.34a")
# version 39
#m24c.2_v39 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2_v39/Gmacsall.out"), model_name = "m24.0c.2_v39") #, version = "2.20.34a")
# version 44 with old tanner fleet designation
m24c.2_v44 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2_v44_tannerold/Gmacsall.out"), model_name = "m24.0c.2_v44") 
m24c.2 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2/Gmacsall.out"), model_name = "m24.0c.2") 

m26.0_v34a <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26s/m26.0/Gmacsall.out"), model_name = "m26.0_v34a", version = "2.20.34a")
#m26.0_v34a <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26s/m26.0_tanner/Gmacsall.out"), model_name = "m26.0_v34a", version = "2.20.34a")
# version 39
#m26.0_v39 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0_v39/Gmacsall.out"), model_name = "m26.0_v39") #, version = "2.20.34a")
# version 44
m26.0_v44 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0_v44_tannerold/Gmacsall.out"), model_name = "m26.0_v44") #, version = "2.20.34a")
m26.0 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0/Gmacsall.out"), model_name = "m26.0") #, version = "2.20.34a")

# new 2026 data runs 
#m24c.2 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2/Gmacsall.out"), model_name = "m24.0c.2") 
#m26.0 <- gmacs_read_allout(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0/Gmacsall.out"), model_name = "m26.0") 
...
m24c.2_v34a_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26s/v34a/gmacs.std"), model_name = "m24.0c.2_v34a" ) #version = "2.20.34a")
m26.0_v34a_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26s/m26.0/gmacs.std"), model_name = "m26.0_v34a") #, version = "2.20.34a")

#m24c.2_v39_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2_v39/gmacs.std"), model_name = "m24.0c.2_v39" ) #version = "2.20.34a")
#m26.0_v39_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0_v39/gmacs.std"), model_name = "m26.0_v39") #, version = "2.20.34a")
# version 44
m24c.2_v44_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2_v44_tannerold/gmacs.std"), model_name = "m24.0c.2_v44" ) #version = "2.20.34a")
m26.0_v44_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0_v44_tannerold/gmacs.std"), model_name = "m26.0_v44") #, version = "2.20.34a")

m24c.2_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m24.0c.2/gmacs.std"), model_name = "m24.0c.2" ) #version = "2.20.34a")
m26.0_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26f/m26.0/gmacs.std"), model_name = "m26.0") #, version = "2.20.34a")

#m26.0a_std <- gmacs_read_std(file = paste0(here::here(), "/BBRKC/bbrkc_26s/m26.0a/gmacs.std"), model_name = "m26.0a")

# model groupings defined here for future plots ----------------
base_models <- list(m24c.2, m26.0)
bridge_mods <- list(m24c.2_v34a, m24c.2_v44, m26.0_v34a, m26.0_v44)
#bridge_mods <- list(m24c.2_v34a, m26.0_v34a)

newD_models <- list(m24c.2_v44, m24c.2, m26.0_v44, m26.0) # comparing new data
#explore_models <- list(m24c.2_v34a, m26.0a, m26.0)

bridge_std <- list(m24c.2_v34a_std, m26.0_v34a_std, m24c.2_v44_std, m26.0_v44_std)
base_std <- list(m24c.2_std,m26.0_std)
newD_std <- list(m24c.2_v44_std, m24c.2_std, m26.0_v44_std, m26.0_std)
#explore_std <- list(m24c.2_v34a_std, m26.0a_std, m26.0_std)

# simplified bridging -----------
gmacs_get_lik_type_pen(all_out = bridge_mods)
#gmacs_plot_index(all_out = list(m24c.2_v39))
data3 <- gmacs_get_index_summary(all_out = bridge_mods)
data3 %>%
  mutate(units = "biomass") -> data3

gmacs_plot_index(all_out = bridge_mods, plot_dir = plot_save_bridge, data_summary = data3)
...
# get BRIDGING likelihood table --------------------
# 
base_like <- gmacs_get_lik(all_out = bridge_mods) #list(m24c.v14, m24c.2_2024, m24c.2)) #base_models <- list(m24c, m24c.1, m24c.1a, m24c.2)
#newD_models <- list(m24c.2, m25.1a, m25.1b, m25.1b2) 
# remove tagging and growth 

base_pen <- gmacs_get_lik_type_pen(all_out = bridge_mods) #list(m24c.v14, m24c.2_2024, m24c.2))

all_like1 <- base_like[c(1:20), ]
all_like2 <- base_pen[c(10, 8, 7), ]
all_like3 <- base_like[c(26,25), ]

ref_all_like4 <- gmacs_get_ref_points(all_out = bridge_mods) #list(m24c.v14, m24c.2_2024, m24c.2))
ref_all_like4 %>% 
  as.data.frame() %>% 
...
row.names(ref_all_like4a) <- c("m24.0c.2_v34a", "m24.0c.2_v44",  "m26.0_v34a", "m26.0_v44")

ref_all_like4a %>% 
  rotate_df() %>% 
  mutate(process = c("b35", "mmb", "f35", "fofl", "ofl_tot")) %>% 
  select(process, m24.0c.2_v34a, m24.0c.2_v44, m26.0_v34a, m26.0_v44 )-> temp2
#select()
...
write.csv(like_all_out, paste0(.TABS, "bridge_likelihood_v44.csv"), row.names = FALSE)


##################----NEW DATA ------
### liklihood ------
gmacs_get_lik_type_pen(all_out = newD_models)
#gmacs_get_lik_type_pen(all_out = explore_models)
...
semp %>% 
  ...
  ggplot(aes(x = size, y = value, linetype  = name, color = model)) +
  geom_line() +
  #geom_line(aes(x = size, y = slx_retention), color = "black") +
  labs(x = "Midpoint of size class (mm)", y = "Selectivity", linetype = NULL, title = "Directed pot fishery \n (males)")+
...
#gmacs_plot_index(all_out = explore_models, plot_dir = plot_save_compare)
...
gmacs_plot_mean_size(all_out = base_models, save_plot = T, plot_dir = plot_save_base)
...
#gmacs_plot_mmb(all_out = explore_models, plot_dir = plot_save_compare, plot_ci = T, std_list = explore_std)
...
gmacs_plot_recruitment(all_out = base_models, save_plot = T, plot_dir = plot_save_base, plot_ci = T, std_list = base_std)
...
gmacs_plot_recruitment(all_out = explore_models, save_plot = T, plot_dir = plot_save_compare)
...
gmacs_plot_f_mmb_dir(all_out = base_models, save_plot = T, plot_dir = plot_save_base)
...
#gmacs_plot_catch_kjp(all_out = explore_models, save_plot = T, plot_dir = plot_save_compare)
...
fem1 <- as.data.frame(m26.0$n_matrix)
...
fem2 %>% 
  ...
  group_by(year) %>% 
  summarise(mat_total = sum(females)/1000000) %>% 
  mutate(model = "m26.0") -> mat_fem2

mat_fem %>% 
  rbind(mat_fem2) -> mat_fem_abn

mat_fem_abn %>% 
  ggplot(aes(year, mat_total, group = model, col = model)) +
  geom_line(lwd =1) +
  expand_limits(y=0) +
...
refT1 <- gmacs_get_ref_points(all_out = base_models) #list(m24c.2, m24c.2_v34a, m26.0))
refT1 <- gmacs_get_ref_points(all_out = newD_models)
refT1 %>% 
  as.data.frame() %>% 
...
nat_mort <- gmacs_get_m(all_out = base_models)
...
base_like <- gmacs_get_lik(all_out = list(m24c.2, m26.0)) #list(m24c.v14, m24c.2_2024, m24c.2)) #base_models <- list(m24c, m24c.1, m24c.1a, m24c.2)
#newD_models <- list(m24c.2, m25.1a, m25.1b, m25.1b2) 
# remove tagging and growth 

base_pen <- gmacs_get_lik_type_pen(all_out = list(m24c.2,  m26.0)) #list(m24c.v14, m24c.2_2024, m24c.2))

all_like1 <- base_like[c(1:20), ]
all_like2 <- base_pen[c(10, 8, 7), ]
all_like3 <- base_like[c(26,25), ]

ref_all_like4 <- gmacs_get_ref_points(all_out = list(m24c.2, m26.0)) #list(m24c.v14, m24c.2_2024, m24c.2))
ref_all_like4 %>% 
  as.data.frame() %>% 
  select(model, b35, mmb, f35, fofl, ofl_tot) %>% 
  mutate(f35 = round(f35, 2), 
...
row.names(ref_all_like4a) <- c("m24.0c.2",  "m26.0")

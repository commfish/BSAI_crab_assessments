...
folder <- "bbrkc_22f/model_22/retrospective" # update annually 
...
mod_names <- c("22.0 (2022)", "2021", "2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013", "2012")
#mod_names <- c("16.0 (2019)", "16.0 (2020)", "16.0a (fix R ter)", "20.1 (no pot)")
.MODELDIR = c(paste0(here::here(), "/BBRKC/bbrkc_22f/model_22/"),
...
ssb2 %>% 
  mutate(ssb = ssb/1000) %>% 
  mutate(model.end.yr = ifelse(Model == '22.0 (2022)', 2021, as.integer(Model)-1)) %>% 

...
knitr::include_graphics("figures/selectivity_23f_BSFRF_Male_most_mods.png", dpi = 200)
```
...
```{r rect1, out.width="100%", fig.cap = "Estimated recruitment time series during 1976-2022 with models 21.1b, 22.0, and 23.0a. Mean male recruits during 1984-2022 was used to estimate B35. Recruitment estimates in the terminal year (2023) are unreliable."}
...
```{r sc-resF3, out.width="100%", fig.cap = "Residuals of proportions of NMFS survey female red king crab by year and carapace length (mm) under model 22.0. Green circles are positive residuals, and red circles are negative residuals."}

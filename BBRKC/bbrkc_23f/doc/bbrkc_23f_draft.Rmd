...
knitr::include_graphics("figures/cpue_catch.png", dpi = 200)
```
...
```{r mmb3, out.width="100%", fig.cap = "Estimated absolute mature male biomasses during 1985-2023 for models 21.1b, 22.0, and 23.0. Mature male biomass is estimated on Feb. 15, year+1."}
